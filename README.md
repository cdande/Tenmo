...
2. **[MOSTLY COMPLETE]** As a user of the system, I need to be able to log in using my registered username and password.
   1. Logging in returns an Authentication Token. I need to include this token with all my subsequent interactions with the system outside of registering and logging in.
   2. The ability to log in has been MOSTLY provided in your starter code.
3. As an authenticated user of the system, I need to be able to see my Account Balance. -- note from Lori: THIS WILL REQUIRE A NEW DATABASE TABLE and its associated DAO pieces!! Make sure you keep reading all the way to the end to see what kinds of DB tables and DAO layer you need!
